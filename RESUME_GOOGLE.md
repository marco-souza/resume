...
**Languages:** TypeScript, JavaScript, Python, Go, Java, Kotlin, Elixir, Rust, Bash

**Backend:** Node.js, Deno, NestJS, Express, Django, Flask, AWS, Terraform, Ansible, Docker, Kubernetes, NGINX

**Databases:** MongoDB, PostgreSQL, SQLite, DynamoDB, Redis, Elasticsearch, Kafka

**Frontend:** React, Next.js, Tailwind CSS, Webpack, Redux, Electron, Service Workers

**Testing & QA:** Jest, Mocha, Pytest, Playwright, Testing Library, MSW

**DevOps:** Git, GitHub, GitHub Actions, GitLab CI, CircleCI, Sentry, Datadog, Linux